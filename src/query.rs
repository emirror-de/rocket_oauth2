...
pub mod param {
    ...
    /// `code_challenge`, the code challenge generated by the `PKCE` extension.
    pub const CODE_CHALLENGE: &str = "code_challenge";

    /// `code_challenge_method`, the method used to generate the `code_challenge`.
    pub const CODE_CHALLENGE_METHOD: &str = "code_challenge_method";

    pub mod code_challenge_method {
        /// `S256`, indicates that the `code_challenge` has been hashed using
        /// `SHA256`.
